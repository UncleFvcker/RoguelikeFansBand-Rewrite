...
当前 `rfb-demo-original` 为内容包 `1.100.0`，content hash 为
`8432e5d6b0143608415de0f49969b6445cd902ef4db58c218c347b5da85cabab`。
它在既有角色成长、构筑、技能、地牢生成、玩家/怪物施法、召唤物命令、装备旗标和动态 affix 纵切之上，包含 Death 四本原创能力书的 32 个对应能力。P58 的 Resonance Mender 验证固定充能设备；P59 新增 Resonance Wand/Staff/Rod，以动态实例 profile 覆盖深度加权 bolt、自疗、持久陷阱侦测、目标前置拒绝、知识门控及存档回读。当前包共 47 terrain、28 actors、23 items、68 abilities、5 ability books、4 affixes、13 skill sets、4 races；现有 dungeon/Vault/encounter/loot/theme 内容继续保留。完整内容锁定见 [`content.lock.json`](rfb-demo-original/content.lock.json)。
