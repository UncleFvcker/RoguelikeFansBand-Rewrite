...
审计日期：2026-09-12。对应[牧师计划](priest-class-plan.md)第一步，当前代码基线 `89910d869`（其父集成基线 `6d028028b03770802c2e7a27e1ad59bcb60d25c3`）。**本步完成来源、映射和消费者核对；Priest Class、Build、职业能力及普通入口仍未实现。** 本批只修改文档，内容1.427.0、协议1.253、State Hash Schema125、save header/payload14/20和contract-v326不变。
...
| 钝器tval21 | 默认2000→7000；sval4双截棍2000→4000；sval40为0→0；sval63为2000→8000；sval5权杖、21战锤为4000→7000 |
