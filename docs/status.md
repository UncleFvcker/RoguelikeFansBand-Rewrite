...
下一职业游侠已完成[七步接入计划](ranger-class-plan.md)的第一步[来源审计](ranger-source-audit.md)：固定自然主领域，第二领域限定咒术、死亡、奥秘、恶魔四选一；已核对160项法术参数、320项武器记录及学习/战斗/生成/奖励/公会消费者，确认不可重复研习、3级MP/学习起点、80共享容量和探测MP→HP支付等实施差异。当前仍未新增职业内容或开放入口；工艺不属于原版游侠候选，混沌/王牌留给后续领域批次。
