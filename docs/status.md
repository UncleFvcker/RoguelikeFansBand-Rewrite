...
| 内容包 | 1.431.0，lock按inspect-source摘要同步；verify待第七步结束后 | [pack](../packs/rfb-demo-original/pack.json)、[lock](../packs/rfb-demo-original/content.lock.json) |
