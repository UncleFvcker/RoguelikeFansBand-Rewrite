...
[黑暗洞穴／灾难区 D1–D5](../design/dark-cave-disaster-area-plan-20260910.md) 已完成 D1 魔法黑暗：照明限制、怪物视觉/夜视/ESP 边界、探测范围缩减与实际消耗进入核心，保留源狙击手照明及昼光反噬例外。35 项不同的相关核心检查通过，world Schema 已生成；正式包仍为 1.401.8，没有新增持久字段或协议 DTO。D2–D5 的废水、生成/生态、39 个楼层定义、守卫奖励与替代入口尚未实施；视觉尺度适配及自动地形发光的现有边界见计划。
