...
下一职业接入[法师](mage-class-plan.md)，已完成第一步[来源与消费者审计](mage-source-audit.md)，范围为现有八领域的 56 个有序双领域组合。审计列明学习/熟练度、第二领域改换、职业参数与公共规则差异、生成/任务/公会及保存消费者；第二至七步尚未实施或开放入口，原版其余四个领域另列后续范围。
