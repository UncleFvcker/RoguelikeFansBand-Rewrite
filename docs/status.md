...
[金字塔土丘 PM1–PM4](../design/pyramidal-mound-dungeon-plan-20260911.md) 已开放埃及神系 2 的 (77,37) 入口和 64–92 共 29 个深度，木乃伊王入口守卫与阿蒙末层守卫均使用既有真实身份。PM2 临时目录已移除，代表地图、埃及生态、奇偶竖井边界和 PM3 掉落专项直接消费正式内容。新增核心闭环经 64→66→…→92 下行，真实近战击杀、奖励落地拾取／使用、保存恢复、逆行返回原荒野入口与召回重入，验证不重复守卫／奖励、其他地牢记账不变。未激活角色不获得入口或守卫，直接转层及读档后资格检查通过。新增地牢状态使 26 条契约仅哈希变化，逐项核对后刷新，政策为 contract-v326。地图适配与准备的 HP、保护状态、位置及 RNG 见计划；没有自然练级、桌面试玩或可玩构建声明。PM5 尚待最终收口。
