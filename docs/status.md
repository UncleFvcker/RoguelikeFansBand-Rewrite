...
后续神器排期见[非QUESTITEM计划](non-quest-artifact-plan.md)：132/309已定义，177件候选分N1–N7，首轮12件普通装备从N1a（6／220／55）开始。19件非QUESTITEM仍缺底材；普通生成与额外命名掉落分别记证据。
...
| 内容包 | 正式包／lock1.466.0 | [pack](../packs/rfb-demo-original/pack.json)、[lock](../packs/rfb-demo-original/content.lock.json) |
