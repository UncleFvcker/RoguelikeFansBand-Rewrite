...
战法师已完成[七步计划](warrior-mage-class-plan.md)的来源审计与正式内容、出生/成长两步。8个主奥秘Build和288项参数已定义；双书出生、1—50级成长、INT法力、负重/手套、武器熟练度、近战次数、感知/美德、三法球成长与智能怪物反魔法权重已实现，8项新专项及共享调用者合计128项、内容专项18项通过。自主重复研习与改换保存、25级转换、生成/奖励/设施、正式UI和桌面实战仍待后续步骤；普通创角保持12职业、94入口。
