...
| 协议 | 1.257，生成绑定已同步 | [协议常量](../crates/rfb-protocol/src/lib.rs) |
...
| 内容包 | 1.436.0，lock 已同步 | [pack](../packs/rfb-demo-original/pack.json)、[lock](../packs/rfb-demo-original/content.lock.json) |
...
正式源目录含 11 个 Class、77 个 Build、57 个 Race、36 本能力书、1,903 个 ability 文件、484 个 item、1,407 个 actor、169 个 affix、152 个 mutation。世界定义含 33 个 dungeon 条目；城镇源目录有 7 个 town、69 个 shop、67 个 townFacility。这些是定义/源文件数量，不是完整规则或已验收内容数量；祖尔验证范围见上文与计划 Z6。
