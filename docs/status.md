...
| 协议 | 1.260 | [协议常量](../crates/rfb-protocol/src/lib.rs) |
...
| 内容包 | 1.443.0 | [pack](../packs/rfb-demo-original/pack.json)、[lock](../packs/rfb-demo-original/content.lock.json) |
...
正式源目录含 13 个 Class、109 个 Build、57 个 Race、36 本能力书、1,907 个 ability、556 个 item、1,409 个 actor、169 个 affix、152 个 mutation。世界定义含 33 个 dungeon；城镇有 7 个 town、69 个 shop、67 个 townFacility。基础分配池为 408 行，固定神器映射 141/392；创角开放 102 个 Build。这些是定义与入口数量，行为验收范围见下文。
