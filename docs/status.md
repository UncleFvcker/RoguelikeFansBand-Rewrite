...
下一组推荐[黑暗洞穴／灾难区 D1–D5](../design/dark-cave-disaster-area-plan-20260910.md)，目前仅完成规划：55–72 / 60–80 层替代组，先补魔法黑暗、深浅废水与生成/生态消费者，再接入 39 个楼层定义、守卫和第四册领域书奖励。规则、内容与入口尚未实施。
