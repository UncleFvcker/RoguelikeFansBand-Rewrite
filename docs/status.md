...
| 内容包 | 1.430.0，lock已同步并验证 | [pack](../packs/rfb-demo-original/pack.json)、[lock](../packs/rfb-demo-original/content.lock.json) |
...
战法师已完成[七步计划](warrior-mage-class-plan.md)前三步。8个主奥秘Build和288项参数已定义；双书出生、1—50级成长、INT法力、负重/手套、武器熟练度、近战次数、感知/美德、三法球成长与智能怪物反魔法权重已实现。自主学习/重复研习、84点预算与历史支出校验、主副熟练度、首用经验、遗忘恢复和改换保存已接通；9项新增学习专项及受影响共享调用者共71项通过，真实地牢练习和读档后自然失败/改换/继续施法保持一致。25级转换、生成/奖励/设施、正式UI和桌面实战仍待后续步骤；普通创角保持12职业、94入口。
