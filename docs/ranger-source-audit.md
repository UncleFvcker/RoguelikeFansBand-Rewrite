...
审计日期：2026-09-11，初次审计对应[游侠计划](ranger-class-plan.md)第一步、基线 `6f9b22c1a6649833bf2ff975878efb8cedb235d3`；第二步在 `1d351f319` 上实现，完成范围见末节。当前已定义 Class/四 Build 和出生/成长，普通入口与桌面验收未开放。内容包 1.423.0；协议 1.253、State Hash Schema 125、save header/payload 14/20 不变。
...
**不作适配豁免的剩余缺口：** 随机学习共享支出/学习美德、主副练习/失败/遗忘及改换保存、射击/森林职业资格、探测能力 MP→HP 支付、Tailored favorite 消费、卷轴 bias、两把奖励弓与任务/公会关联。职业/160项参数、3级MP/容量起点、普通减耗/易施法资格、两项等级伤害、装备感知已在第二步完成。
