...
> 历史记录：2026-09-09 起的新一轮安排见 [三工作树、四对话并行开发交接](parallel-development-handoff-20260909.md)。种族职业与集成共用 main，另两个方向使用独立工作树。下文旧分支、版本预留及各批“当前”仅表示其记录时点，不作为新对话的分支起点或待办清单。
