...
/// sustains and literal `pspeed`, `spell_cap` and regeneration adjustments.
...
"#;
        ...
        let (resistances, _, _, _, _, _, _, _, _, _) =
        ...
        assert_eq!(race["abilities"].as_array().map(Vec::len), Some(12));
