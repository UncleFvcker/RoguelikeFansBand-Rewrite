...
const fn damage_type_dto(value: ActorDamageType) -> DamageTypeDto {
    match value {
        ...
        ActorDamageType::Rock => DamageTypeDto::Rock,
...
const fn actor_damage_type(value: DamageTypeDto) -> Option<ActorDamageType> {
    Some(match value {
        ...
        DamageTypeDto::Rock => ActorDamageType::Rock,
...
const fn equipment_passive(value: EquipmentPassiveDto) -> EquipmentPassive {
    match value {
        ...
        EquipmentPassiveDto::PassWall => EquipmentPassive::PassWall,
        EquipmentPassiveDto::NoPasswallDamage => EquipmentPassive::NoPasswallDamage,
