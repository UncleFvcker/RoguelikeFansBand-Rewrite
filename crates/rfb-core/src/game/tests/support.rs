...
pub(super) fn zombie_game(seed: u64) -> Game {
    Game::new_with_build_race_and_name(
        seed,
        "demo.build.warrior",
...
pub(super) fn skeleton_game(seed: u64) -> Game {
    Game::new_with_build_race_and_name(
        seed,
        "demo.build.warrior",
...
pub(super) fn snotling_game(seed: u64) -> Game {
    Game::new_with_build_race_and_name(
        seed,
        "demo.build.warrior",
...
pub(super) fn einheri_game(seed: u64) -> Game {
    Game::new_with_build_race_and_name(
        seed,
        "demo.build.warrior",
...
pub(super) fn kutar_game(seed: u64) -> Game {
    Game::new_with_build_race_and_name(
        seed,
        "demo.build.warrior",
...
pub(super) fn amberite_game(seed: u64) -> Game {
    Game::new_with_build_race_and_name(
        seed,
        "demo.build.warrior",
...
pub(super) fn beastman_game(seed: u64) -> Game {
    Game::new_with_build_race_and_name(
        seed,
        "demo.build.warrior",
...
pub(in crate::game) fn give_inventory_item(game: &mut Game, id: &str, kind_id: &str) {
