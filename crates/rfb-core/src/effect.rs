...
pub const STATUS_MAGIC_ARMOR: &str = "rfb.status.magic-armor";
pub const STATUS_WEAPON_MASTERY: &str = "rfb.status.weapon-mastery";
pub const STATUS_MANA_BRAND: &str = "rfb.status.mana-brand";
