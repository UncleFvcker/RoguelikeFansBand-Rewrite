...
impl From<DamageType> for DamageTypeDto {
    fn from(value: DamageType) -> Self {
        match value {
            ...
            DamageType::Blindness => Self::Blindness,
            DamageType::Fear => Self::Fear,
...
impl From<DamageTypeDto> for DamageType {
    fn from(value: DamageTypeDto) -> Self {
        match value {
            ...
            DamageTypeDto::Blindness => Self::Blindness,
            DamageTypeDto::Fear => Self::Fear,
...
impl From<rfb_content::ActorDamageType> for DamageType {
    fn from(value: rfb_content::ActorDamageType) -> Self {
        match value {
            ...
            rfb_content::ActorDamageType::Blindness => Self::Blindness,
            rfb_content::ActorDamageType::Fear => Self::Fear,
            ...
            rfb_content::ActorDamageType::Rock => Self::Rock,
