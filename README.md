...
- 协议版本 `1.201`，State Hash Schema `v100`。
- 行为基线 `contract-v303`，共 26 个 exact fixture。
- 内容包 `1.334.0`：104 种地形、1402 种角色、316 种物品、1666 个能力、16 本能力书、15 张掉落表、152 项变异定义；当前开放战士、死亡/奥秘/咒术/毁灭领域的高阶法师、弓箭手、固定死亡领域的圣骑士、骑兵和狙击手，以及 Human、半兽人、高等精灵三个新游戏种族。Human 与半兽人开放当前已闭环的 20 项半神天赋选择；高等精灵没有等级奖励或种族能力菜单。登丹人内容已经正式化，但尚未加入新游戏选择入口。
