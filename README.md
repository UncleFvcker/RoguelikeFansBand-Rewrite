...
- 协议版本 `1.192`，State Hash Schema `v96`。
- 行为基线 `contract-v290`，共 26 个聚焦的 exact fixture，零豁免。
- 内容包 `1.303.0`：97 种地形、1080 种角色、304 种物品、788 个能力、152 项变异定义；当前开放战士、固定死亡领域的高阶法师、弓箭手、固定死亡领域的圣骑士和骑兵。
