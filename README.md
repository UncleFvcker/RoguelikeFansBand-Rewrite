...
- 协议版本 `1.192`，State Hash Schema `v93`。
- 行为基线 `contract-v284`，共 26 个聚焦的 exact fixture，零豁免。
- 内容包 `1.301.0`：104 种地形、1079 种角色、306 种物品、818 个能力、152 项变异定义；当前开放战士、死亡或奥秘领域的高阶法师、弓箭手和固定死亡领域的圣骑士。奥秘第四册已登记前七个法术，但整册在最后一个法术完成前不提供获取途径。
