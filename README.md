...
- 协议版本 `1.210`，State Hash Schema `v103`。
- 行为基线 `contract-v303`，共 26 个 exact fixture。
- 内容包 `1.345.0`：104 种地形、1402 种角色、323 种物品、1730 个能力、23 本能力书、15 张掉落表、152 项变异定义；当前开放战士、死亡/奥秘/咒术/毁灭/自然完整领域及生命前三册的高阶法师、弓箭手、固定死亡领域的圣骑士、骑兵和狙击手，以及 Human、半兽人、高等精灵、登丹人、野蛮人、霍比特人、狗头人、矮人、尼伯龙人、侏儒、半巨人、半巨魔、半泰坦十三个新游戏种族。Human、半兽人、登丹人与野蛮人开放当前已闭环的 20 项半神天赋选择；其余正式种族没有等级奖励。野蛮人与半巨魔的种族狂暴、霍比特人的制造食物、狗头人的毒镖、矮人与尼伯龙人的侦测能力、侏儒的相位之门、半巨人的化石为泥，以及半泰坦的探测怪物已通过统一先天能力入口开放。
