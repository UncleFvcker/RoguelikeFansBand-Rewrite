...
- 协议版本 `1.200`，State Hash Schema `v99`。
- 行为基线 `contract-v301`，合并前仍需按交接刷新并复验 26 个 exact fixture。
- 内容包 `1.317.0`：104 种地形、1211 种角色、308 种物品、1144 个能力、152 项变异定义；当前开放战士、死亡或奥秘领域的高阶法师、弓箭手、固定死亡领域的圣骑士、骑兵和狙击手。Human 已开放 20 项当前闭环的 20 级半神天赋选择。
