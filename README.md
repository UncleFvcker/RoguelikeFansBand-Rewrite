...
- 内容包 `1.331.0`：104 种地形、1402 种角色、316 种物品、1666 个能力、16 本能力书、15 张掉落表、152 项变异定义；当前开放战士、死亡/奥秘/咒术/毁灭领域的高阶法师、弓箭手、固定死亡领域的圣骑士、骑兵和狙击手，以及 Human、半兽人两个正式种族。两者均开放当前已闭环的 20 项半神天赋选择。
