...
- 行为基线 `contract-v302`，共 26 个 exact fixture。
- 内容包 `1.320.0`：104 种地形、1211 种角色、316 种物品、1208 个能力、16 本能力书、152 项变异定义；当前开放战士、死亡/奥秘/咒术/毁灭领域的高阶法师、弓箭手、固定死亡领域的圣骑士、骑兵和狙击手。Human 已开放 20 项当前闭环的 20 级半神天赋选择。
