...
- 协议版本 `1.175`，State Hash Schema `v87`。
- 行为基线 `contract-v265`，共 21 个聚焦的 exact fixture，零豁免。
- 内容包 `1.258.0`：66 种地形、647 种角色、259 种物品、335 个能力、152 项变异定义；当前开放战士、固定死亡领域的高阶法师和弓箭手。
