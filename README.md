...
- 内容包 `1.332.0`：105 种地形、1402 种角色、317 种物品、1666 个能力、16 本能力书、16 张掉落表、152 项变异定义；当前开放战士、死亡/奥秘/咒术/毁灭领域的高阶法师、弓箭手、固定死亡领域的圣骑士、骑兵和狙击手。Human 已开放 20 项当前闭环的 20 级半神天赋选择。
