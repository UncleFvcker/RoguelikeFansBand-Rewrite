...
- 协议版本 `1.189`，State Hash Schema `v94`。
- 行为基线 `contract-v285`，共 26 个聚焦的 exact fixture，零豁免。
- 内容包 `1.310.0`：97 种地形、1202 种角色、302 种物品、1082 个能力、152 项变异定义；当前开放战士、固定死亡领域的高阶法师、弓箭手和固定死亡领域的圣骑士。
