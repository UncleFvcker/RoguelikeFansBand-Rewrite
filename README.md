...
- 协议版本 `1.182`，State Hash Schema `v90`。
- 行为基线 `contract-v274`，共 21 个聚焦的 exact fixture，零豁免。
- 内容包 `1.281.0`：92 种地形、930 种角色、302 种物品、551 个能力、152 项变异定义；当前开放战士、固定死亡领域的高阶法师和弓箭手。
