...
- 协议版本 `1.222`，State Hash Schema `v105`，save header/payload schema `v3`（二进制容器格式仍为 v1）。
- 行为基线 `contract-v303`，共 26 个 exact fixture。
- 内容包 `1.365.0`：133 种地形、1402 种角色、345 种物品、1829 个能力、32 本能力书、31 张掉落表、152 项变异定义；当前开放战士，死亡、奥秘、咒术、毁灭、自然、生命、恶魔和圣战八个完整领域的高阶法师，弓箭手、固定死亡领域的圣骑士、骑兵和狙击手，以及 Human、半兽人、高等精灵、登丹人、野蛮人、霍比特人、狗头人、矮人、尼伯龙人、侏儒、半巨人、半巨魔、半泰坦、独眼巨人、伊克人、克拉克人、黑暗精灵、夺心魔、小恶魔、九个龙人亚种和魔像。Human、半兽人、登丹人与野蛮人开放当前已闭环的 20 项半神天赋选择，龙人在 35 级开放九项龙力选择。野蛮人与半巨魔的种族狂暴、霍比特人的制造食物、狗头人的毒镖、矮人与尼伯龙人的侦测能力、侏儒的相位之门、半巨人的化石为泥、半泰坦的探测怪物、独眼巨人的投掷巨石、伊克人的恐吓怪物、克拉克人的喷吐酸液、黑暗精灵的魔法飞弹、夺心魔的心灵震爆、小恶魔的火焰能力、龙人的喷吐和魔像的石肤术已通过统一先天能力入口开放；恶魔领域的临时恶魔与恶魔领主形态也复用该入口。除既有地牢外，鹰巢、迷宫、孤山、矿井、战场、努曼诺尔/亚特兰蒂斯、龙穴、城堡、巨人殿堂、雪之城堡、墓地、女巫森林和奥兹平原也已接入正式世界与奖励路径。
