...
- 协议版本 `1.176`，State Hash Schema `v88`。
- 行为基线 `contract-v271`，共 21 个聚焦的 exact fixture，零豁免。
- 内容包 `1.273.0`：92 种地形、931 种角色、302 种物品、551 个能力、152 项变异定义；当前开放战士、固定死亡领域的高阶法师、弓箭手和固定死亡领域的圣骑士。
