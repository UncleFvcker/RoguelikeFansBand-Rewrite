...
- 协议版本 `1.208`，State Hash Schema `v103`。
- 行为基线 `contract-v303`，共 26 个 exact fixture。
- 内容包 `1.337.0`：104 种地形、1402 种角色、323 种物品、1722 个能力、23 本能力书、15 张掉落表、152 项变异定义；当前开放战士、死亡/奥秘/咒术/毁灭/自然完整领域及生命前三册的高阶法师、弓箭手、固定死亡领域的圣骑士、骑兵和狙击手。Human 已开放 20 项当前闭环的 20 级半神天赋选择。
