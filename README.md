...
- 协议版本 `1.198`，State Hash Schema `v98`。
- 行为基线 `contract-v295`，共 26 个聚焦的 exact fixture，零豁免。
- 内容包 `1.313.0`：104 种地形、1211 种角色、308 种物品、1142 个能力、152 项变异定义；当前开放战士、死亡或奥秘领域的高阶法师、弓箭手、固定死亡领域的圣骑士、骑兵和狙击手。奥秘四册共 32 个法术，均已提供正式获取路径。
