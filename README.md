...
当前原创规则契约位于 [`tests/fixtures/contract-v101/scenarios`](tests/fixtures/contract-v101/scenarios)，由 `rfb-contract` 在所有平台运行；`contract-v1` 至 `contract-v100` 作为历史基准保留。
