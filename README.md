...
- 协议版本 `1.218`，State Hash Schema `v104`，save header/payload schema `v2`（二进制容器格式仍为 v1）。
- 行为基线 `contract-v303`，共 26 个 exact fixture。
- 内容包 `1.355.0`：111 种地形、1402 种角色、335 种物品、1803 个能力、32 本能力书、21 张掉落表、152 项变异定义；当前开放战士，以及死亡、奥秘、咒术、毁灭、自然、生命、恶魔、圣战八个完整领域的高阶法师、弓箭手、固定死亡领域的圣骑士、骑兵和狙击手，以及 Human、半兽人、高等精灵、登丹人、野蛮人、霍比特人、狗头人、矮人、尼伯龙人、侏儒、半巨人、半巨魔、半泰坦十三个新游戏种族。Human、半兽人、登丹人与野蛮人开放当前已闭环的 20 项半神天赋选择；其余正式种族没有等级奖励。野蛮人与半巨人的种族狂暴、霍比特人的制造食物、狗头人的毒镖、矮人与尼伯龙人的侦测能力、侏儒的相位之门、半巨人的化石为泥，以及半泰坦的探测怪物已通过统一先天能力入口开放；恶魔领域的临时恶魔与恶魔领主形态也沿用该入口提供吐息及形态能力。除 Warrens 与兽人洞穴外，卡美洛、潮汐洞穴、黏液洞穴、藏身处、隐秘天地和巨魔洞穴也已形成可进入、可征服并可保存恢复的完整地牢循环。
