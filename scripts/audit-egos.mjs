...
const conditionScopes = [
  ...
  ["base-theme", "object2.c", 3500, 3558, "partial-base-allocation", "12 formal enum themes referencing one source pool", "theme takes precedence over tailored; source predicates choose full base pools", "formal lootTables; loot/allocation.rs; loot.rs", "shared static candidate domains and theme Ego integration", "full scheduler and stochastic theme acceptance; WARRIOR_SHOOT/JUNK caller mapping pending"],
...
const report = {
  ...
  unresolvedSharedGenerationContracts: [
    ...
    { scope: "source base allocation", contract: "B0 provides canonical source allocation rows, all current candidate identities and shared static theme domains; full category/good/great/tailored allocation, stochastic theme acceptance, favorite weapon/slot filters, book found counters and Acquirement failure retries remain pending", source: "src/object2.c:2416-3678; :4471" },
