...
```powershell
cargo run -p rfb-contract -- observe tests/fixtures/contract-v13/scenarios/01-move-north.json
cargo run -p rfb-contract -- verify tests/fixtures/contract-v13/scenarios/01-move-north.json
```
