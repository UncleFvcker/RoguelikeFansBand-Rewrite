...
状态：长期规则实现路线；当前基线为协议 1.94 / contract-v94（P31–P37 进展见 8.3 与[待实现内容清单](pending-implementation.md)）
