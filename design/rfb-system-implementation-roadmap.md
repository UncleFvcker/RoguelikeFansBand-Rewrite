...
状态：长期规则实现路线；当前基线为协议 1.160 / contract-v239 / state hash Schema v79（P31–P98 进展见 8.3，玩家流程与 Outpost 进展见 Phase 17/18，物品与变异接入见 Phase 19，Warrens 怪物机制见 W1–W14 清单，荒野世界图见 W0–W5、区块卷动、条带怪物生成、客户端同步与连续城镇）
