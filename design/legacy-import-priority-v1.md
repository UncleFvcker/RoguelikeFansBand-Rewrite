...
| T3 | P52 | **职业壳 + m_info 施法档案导入**：54 职业 stats/skills/casting 壳、领域可读性表；s_info 记差异 | 为玩家法术线铺挂靠点 |
| T4 | P53+ | **玩家领域法术逐族映射**（按领域覆盖数分批）∥ **设备/消耗品效果系统**（可并行插队） | 前者复用怪物法术线方法论与效果词汇；后者解锁 231+193 缺口且与职业道具协同 |
