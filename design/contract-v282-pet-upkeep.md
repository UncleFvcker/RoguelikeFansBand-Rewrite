...
- Protocol 1.184，集成内容包 1.282.0，content hash 以当前 `content.lock.json` 为准。
- 无新增存档字段，State Hash Schema 保持 v92。
- 公共玩家投影新增派生维持摘要，active exact fixture 统一刷新到
  `contract-v282`，零 waiver。
