...
P53 已选择 Death 第一册建立首个真实 ability、ability book、实体书、Mana 与职业 casting profile 纵切；逐职业等级/耗魔/失败率通过 `abilityOverrides` 保真，详见 [旧版玩家领域法术导入 v1](legacy-player-spell-import-v1.md)。力量、敏捷、体质、生命施法以及职业专属 spells 继续保留在施法壳中，待对应通用 surface 覆盖后接入。
