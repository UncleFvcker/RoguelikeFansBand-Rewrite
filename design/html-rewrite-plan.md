...
- 协议 1.53 和 contract-v53 已建立；内容包 1.46.0 新增分阶段 layout、连通 cavern 基础地貌、4/5 房间数量与面积预算、加权 rectangle/cross 形状和跨非入口房间的 encounter/loot 分布。save v1 / state hash Schema v19 不变，active baseline 共 106 个 exact fixtures。
