...
- 协议 1.118 和 contract-v118 已建立；P67 的物品类别召唤、深度/玩家等级来源、Race `kinCategory`、永久 Pet/Kin 与零结果知识/RNG 边界保持不变。v118 将装备 passive 收缩为已有权威消费者的 regeneration 与 vampiric，13 类未实现旗标回到真实导入 gap report。内容包 1.109.0，content hash 为 `99398a53687b4cf106939ddebcb08865f4a24ee147795e9de2ae8e08036aaf00`，active baseline 共 420 个 exact fixtures、零 waiver，state hash 保持 Schema v52。
