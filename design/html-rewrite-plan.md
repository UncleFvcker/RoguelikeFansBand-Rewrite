...
- 协议 1.11 和 contract-v11 已建立；伤害/死亡事件携带原始伤害、物理减伤、抗性调整、最终伤害、类型和等级的结构化 outcome；内容包 1.7.0 为酸、电、火、冷、毒提供独立近战来源，active baseline 共 45 个 exact fixtures，state hash Schema 继续为 v9。
...
1. 继续 contract-v11 收尾阶段 B：建立带来源的派生属性与检定接口；随后在该接口上实现眩晕与恐惧；
