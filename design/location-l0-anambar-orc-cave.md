...
After contract-v256, `audit-demo-monsters` is the authority for the remaining
level 21–32 records. The global import selection retains 191 records in this
range; 181 are directly expressible Orc Cave allocation candidates. The other
...
1. 17 records blocked by a real monster mechanism.
