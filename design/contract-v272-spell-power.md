...
- 内容包 1.280.0，content hash
  `74ebf04606043937c1fc91177814b7cb03499f28648143b226505289b37b14be`。
- Protocol 1.180、State Hash Schema v89，save v1 不变。
- `StatModifiersDto` 新增 `spellPowerBonus`，改变全部 active fixture 的公共投影和状态哈希；
  因此统一刷新 21 条 exact fixture，行为基线提升为 contract-v272，零 waiver。
