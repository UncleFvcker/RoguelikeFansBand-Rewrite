...
状态：基于 contract-v1–v79、前端目标模式和系统路线书审计；每完成一个纵切后同步更新
...
| P20 | 定点延长射线与更一般的形状组合 | 下一候选 | 在现有 area/beam/cone 公共管线之上探索定点延长射线、形状组合和内容驱动参数；多资源与怪物施法继续后置 |

## contract-v79 明确遗留

- 定点延长射线、位移、召唤、侦测和地形改变；
- 射线范围内物品破坏、地形变更或玩家伤害；
- 定点/实体目标的射线延长、反射、穿透墙体例外和怪物施法；
- 多资源职业和怪物能力选择/施法 AI；
- 原版完整法术书、法术顺序和按等级自动遗忘/记起模型。

RFB 式方向射线、actor 穿透、墙体截断、近到远顺序、共享单次伤害骰、空射/无效模式 RNG 边界和 Echo Lance 已由 contract-v78 建立；固定八向锥形、逐层展开、墙体截断、横向整数衰减、空锥/无效模式 RNG 边界和 Echo Fan 已进入协议 1.79、内容包 1.71.0、save v1 与 state hash Schema v34；active baseline 为 198 个 exact fixtures、零 waiver。详细边界见 [contract-v79](contract-v79-cone-damage.md)。

## contract-v77 明确遗留

- 锥形、定点延长射线、位移、召唤、侦测和地形改变；
- 范围内物品破坏、地形变更或玩家伤害；
- 多资源职业和怪物能力选择/施法 AI；
- 原版完整法术书、法术顺序和按等级自动遗忘/记起模型。
...
- 自身目标与治疗已由 contract-v74 完成；范围爆发已由 contract-v77 完成，方向射线已由 contract-v78 完成，锥形已由 contract-v79 完成，定点延长射线、位移、召唤、侦测和地形改变能力仍未实现；
...
- Mana、能力书、失败率、恢复、自身治疗、熟练度和冷却已由 contract-v73–v75 完成；学习容量、遗忘和完整法术系统仍未实现。
