...
test("new character creation exposes the formal Warrior and Death High-Mage slices", () => {
  assert.deepEqual(PLAYTEST_BUILD_IDS, ["demo.build.warrior", "demo.build.high-mage-death"]);
