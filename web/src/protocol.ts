...
export type StatusDto = { kindId: string, intensity: number, remainingTicks: number, grantedResistances?: Array<ResistanceDto>, grantedBrands?: Array<WeaponBrandDto>, };
