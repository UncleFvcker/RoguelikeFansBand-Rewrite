...
export type AbilityEffectSpecDto = { "type": "damage", damageDice: number, damageSides: number, damageBonus: number, damageType: DamageTypeDto, } | { "type": "area-damage", damageDice: number, damageSides: number, damageBonus: number, damageType: DamageTypeDto, radius: number, } | { "type": "beam-damage", damageDice: number, damageSides: number, damageBonus: number, damageType: DamageTypeDto, } | { "type": "cone-damage", damageDice: number, damageSides: number, damageBonus: number, damageType: DamageTypeDto, radius: number, } | { "type": "teleport" } | { "type": "summon", actorKindId: string, count: number, radius: number, durationTurns: number, } | { "type": "detect", category: string, radius: number, persistent: boolean, } | { "type": "transform-terrain", sourceTerrainIds: Array<string>, targetTerrainId: string, radius: number, } | { "type": "apply-status", statusKindId: string, intensity: number, durationTicks: number, stacking: AbilityStatusStackingDto, resistanceType?: DamageTypeDto | null, } | { "type": "blink-self", radius: number, } | { "type": "teleport-self", minimumDistance: number, } | { "type": "teleport-target" } | { "type": "remove-status", statusKindId: string, } | { "type": "heal", amount: number, };
