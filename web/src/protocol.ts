...
export type ItemDto = { id: string, kindId: string, displayNameKey: string, knowledge: ItemKnowledgeDto, position: Position, quantity: number, enchantments?: ItemEnchantmentsDto, };
