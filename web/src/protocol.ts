...
export type GameUpdate = { baseRevision: number, revision: number, turn: number, worldTick: number, commandSeq: number, floorId: string, dungeonInstanceId?: string | null, town?: TownDto | null, shops: Array<ShopDto>, homes: Array<HomeDto>, taskServices: Array<TaskServiceDto>, events: Array<GameEventDto>, changedCells: Array<CellDto>, changedVisualCells: Array<CellVisualDto>, player: PlayerDto, entities: Array<EntityDto>, items: Array<ItemDto>, goldPiles: Array<GoldPileDto>, inventory: Array<InventoryItemDto>, equipment: Array<EquipmentItemDto>, removedEntities: Array<string>, terrainInteractions: Array<TerrainInteractionDto>, tasks: Array<TaskStatusDto>, campaign: CampaignStateDto, stateHash: string, };
