...
async function main() {
  ...
  try {
    ...
    } else if (process.argv.includes("--angband")) {
      await runTownMapScenario(client, path.join(artifactDirectory, "angband"), debugProfile, "angband");
